...
public class VentanaCiudad extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        data[0][0]=this.ciudadControl.listar().get(0).getCodigo();
        data[0][1]=this.ciudadControl.listar().get(0).getCodigo();
        data[0][2]=this.ciudadControl.listar().get(0).getCodigo();
        data[0][3]=this.ciudadControl.listar().get(0).getCodigo();
